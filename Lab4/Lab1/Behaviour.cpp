...
SteeringOutput Swarm::getSteering(sf::Vector2f t_currentPos, sf::Vector2f t_playerPos, float& t_rotation, sf::Vector2f t_velocity, sf::Vector2f t_playerVelocity)
{
	...
	if (t_velocity == sf::Vector2f(0.0f,0.0f))
	{
		direction = sf::Vector2f(rand() % 800, rand() % 600) - t_currentPos;
	}
	else
	{
		direction = t_velocity;
	}
...
SteeringOutput Formation::getSteering(sf::Vector2f t_currentPos, sf::Vector2f t_playerPos, float& t_rotation, sf::Vector2f t_velocity, sf::Vector2f t_playerVelocity)
{
	SteeringOutput steering;
...
sf::Keyboard::Key Formation::getKey()
{
